...
const projects = [
  // ... (los proyectos permanecen igual) ...
  {
    id: 1,
    image: "/images/proyecto1.png",
    link: "https://github.com/Natalia-Schwindt/proyectoFinalReact",
...
const Projects = () => {
  ...
  return (
    <Flex
      as="section"
      // Eliminamos el margen superior para que no interfiera en la versión de escritorio
      mt={{ base: "90px", md: "0px" }}
      px={4}
      color="white"
      direction="column"
      // Eliminamos la altura fija (h="100%"). El contenedor se adaptará a su contenido
      // h="100%"
    >
      <Heading
        as="h2"
      ...
      <Box
        // Eliminamos la altura máxima fija. El contenedor de tarjetas se adaptará al contenido
        // maxH={{ base: "calc(95vh - 345px)", lg: "calc(90vh - 200px)" }}
        // Eliminamos overflowY="auto" para que el scroll lo maneje el body, no este contenedor
        // overflowY="auto"
        flex="1" // flex: 1; es una abreviación de flex-grow: 1; flex-shrink: 1; y flex-basis: 0%;
      >
        {projects.map((project, index) => (
          <Flex
            key={project.id}
